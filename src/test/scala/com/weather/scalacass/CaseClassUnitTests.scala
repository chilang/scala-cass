...
class CaseClassUnitTests extends CassandraTester("testDB", "testTable", List("str varchar", "str2 ascii", "b blob",
  ...
  case class Everything2(str2: String, d: BigDecimal, f: Float, net: java.net.InetAddress, ld: LocalDate, l: Option[List[String]])
  ...
  "case class with Everything" should "materialize" in {
    ...
    val e2 = Everything2(e.str, e.d, e.f, e.net, LocalDate.now, e.l)
